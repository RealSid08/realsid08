  ...
  const toggleSession = async () => {
    ...
    if (isActive) {
      ...
      try {
        ...
        alert('Could not start the voice demo. Try again in a moment.');
      } finally {
      ...
      <div className="flex flex-col items-center text-center">
        <div className="mb-8">
            <div className="flex items-center justify-center gap-4 mb-2">
                <h2 className="text-3xl font-light text-white tracking-widest">Voice demo</h2>
          ...
          <p className="text-gray-500 text-xs font-mono uppercase">Live speech, powered by the OpenAI Realtime API</p>
        </div>
