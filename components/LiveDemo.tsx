...
import { LiveSessionManager } from '../services/gemini';
      ...
      <div className="flex flex-col items-center text-center">
        <div className="mb-8">
            <div className="flex items-center justify-center gap-4 mb-2">
                <h2 className="text-3xl font-light text-white tracking-widest">AURA HUB</h2>
          ...
          <p className="text-gray-500 text-xs font-mono uppercase">Gemini Multimodal Live API Connection</p>
        </div>
